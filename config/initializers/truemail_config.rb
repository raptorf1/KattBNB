Truemail.configure do |config|
  ...
  # Optional parameter. An SMTP server response timeout in seconds.
  # It is equal to 2 by default.
  ...
  # always will return true. Other validations will not be processed even if it
  ...
  # will be passed to Regex, MX or SMTP validators. Validation of email which
  ...
  # Optional parameter. This option will parse bodies of SMTP errors. It will
