RSpec.describe Api::V1::HostProfilesController, type: :request do
  ...
  let(:booking) { FactoryBot.create(:booking, host_nickname: user2.nickname, user_id: user.id, dates: [1562889600000, 1562976000000]) }
  ...
  describe 'DELETE /api/v1/bookings/id' do
    ...
    it 'deletes the booking of the associated user and does not delete the user' do
