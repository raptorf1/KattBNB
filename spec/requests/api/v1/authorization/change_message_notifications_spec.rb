...
RSpec.describe 'User Changes Message Notification and API', type: :request do
  ...
  it 'returns a user and a token and then updates the message_notification field in under 1 ms and with iteration rate of 5000000 per second' do
    ...
    put_request = put '/api/v1/auth', params: { message_notification: false,
                                                uid: new_user_uid,
                                                'access-token': new_user_token,
                                                client: new_user_client
                                             }, headers: headers
