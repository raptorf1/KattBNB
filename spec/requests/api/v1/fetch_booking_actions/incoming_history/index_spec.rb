RSpec.describe "GET /api/v1/fetch_booking_actions/incoming_history", type: :request do
  ...
  describe "successfully" do
    describe "when host profile exists" do
      before { get "/api/v1/fetch_booking_actions/incoming_history", headers: host_headers }
  ...
  describe "unsuccessfully" do
    describe "if user is not logged in" do
      before { get "/api/v1/fetch_booking_actions/incoming_history", headers: unauthenticated_headers }
