RSpec.describe "GET /api/v1/fetch_booking_actions/incoming_upcoming", type: :request do
  ...
  describe "successfully" do
    describe "when host profile exists" do
      before { get "/api/v1/fetch_booking_actions/incoming_upcoming", headers: host_headers }
    ...
    describe "when host profile does not exist" do
      before { get "/api/v1/fetch_booking_actions/incoming_upcoming", headers: random_user_headers }
  ...
  describe "unsuccessfully" do
    describe "if user is not logged in" do
      before { get "/api/v1/fetch_booking_actions/incoming_upcoming", headers: unauthenticated_headers }
