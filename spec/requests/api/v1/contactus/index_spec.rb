...
RSpec.describe 'User can fill contact us form in the front-end and API', type: :request do
    ...
    it 'responds with 422 if email is invalid' do
      ...
      expect(json_response['error']).to eq ["There was a problem validating your email! You sure it's the right one? You can always find us by following our social media links below."]
