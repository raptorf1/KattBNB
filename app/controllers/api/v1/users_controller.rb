class Api::V1::UsersController < ApplicationController
  ...
  def show
    ...
    user.nil? && (render json: { errors: [I18n.t("controllers.reusable.not_found_error")] }, status: 400) and return
  ...
  def update
    ...
    params[:profile_avatar].nil? &&
      (render json: { errors: [I18n.t("controllers.users.no_avatar_error")] }, status: 400) and return
